...
class MessagesSmallTests extends Repository
{

    /**
     * MessageSmallTest constructor.
     */
    public function __construct()
    {
        parent::__construct(new MessageSmallTest());
    }

    /**
     * @param $request
     */
    public function save($request, $languages=null)
    {
        if ($languages) {
    ...
    private function saveByLanguage( $saveData){
        $data = new MessageSmallTest();
        $data->small_test_id = rand(10,100);
