...
class CreateMessagesBigTestTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('messages_big_test', function (Blueprint $table) {
            $table->increments('id');                   // Message ID (auto increment)
            $table->unsignedInteger('grade_id');     // Big Test ID
    ...
    {
        Schema::dropIfExists('messages_big_test');
    }
}
