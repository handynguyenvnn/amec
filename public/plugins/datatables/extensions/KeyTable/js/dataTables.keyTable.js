...
KeyTable = function ( oInit )
{
	 ...
	 * Purpose:  Create a function (with closure for sKey) event addition ApiValidators
	...
	function _fnEventAddTemplate( sKey )
	{
		/*
		 * Function: -
		 * Purpose:  ApiValidators function for adding event to cache
		 * Returns:  -
	 ...
	 * Purpose:  Create a function (with closure for sKey) event removal ApiValidators
	 * Returns:  function: - template function
	 * Inputs:   string:sKey - type of event to detect
	 */
	function _fnEventRemoveTemplate( sKey )
	{
		/*
		 * Function: -
		 * Purpose:  ApiValidators function for removing event from cache
	...
	/* Use the template functions to add the event ApiValidators functions */
