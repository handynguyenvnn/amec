    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                <!-- form start -->
                <form id="form" class="form-horizontal" method="post" action="{{ route('announcements.update', $data->id) }}">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input maxlength="100" type="text" class="form-control" name="subject" id="inputTitle" value="{!! $data->subject !!}" placeholder="件名">
                            </div>
                        </div>
                        <div class="form-group">
