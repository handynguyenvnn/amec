<div class="modal fade bs-example-modal-xs" id="modal-add" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <form id="formLanguage" action="{{ route('languages.store') }}" method="post" class="form-horizontal">
                {{ csrf_field() }}
