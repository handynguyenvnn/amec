...
@section('stylesheet')
    <link rel="stylesheet" href="{{ asset('css/collection/maker.css') }}">
@endsection
...
@section('content')
    ...
    <div class="box box-primary">
        ...
        <div class="box-header with-border">
            <div class="box-body">
                <div id="add-maker">
                    <form method="post" class="form-horizontal" action="{{ route("makers.store") }}" id="createForm">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="box-body">
                                <div class="form-group">
                                    <label for="inputMakerName" class="col-sm-2 col-sm-offset-4 control-label">メーカー名入力欄</label>
                ...
                <hr style="height: 1px; color: #008000;" />
                <div id="search-maker">
                    <form class="form-horizontal" action="{!! route("makers.index") !!}">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputMakerSearch" class="col-sm-2 col-sm-offset-4 control-label">メーカー名</label>
                    ...
                    @if(count($data))
                        @foreach($data as $items)
                            <tr>
                                ...
                                <td>{!! $items->name !!}</td>
                                <td>
                                    <button data-action="{{ route('makers.destroy', $items->id) }}" type="button"
...
@section('javascript')
    ...
    <script src="{{ asset('js/collection/maker.js') }}"></script>
@endsection