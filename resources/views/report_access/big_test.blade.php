        ...
        <div class="box-header with-border">
            <div>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation"><a href="{{ route('access-analysis.index') }}"
                                               aria-controls="juukousha"
                                               role="tab">チャプター別<br/>受講者数</a></li>
                    <li role="presentation" class="active"><a href="{{ route('access-analysis.big-tests') }}" aria-controls="juukensha"
                                                              role="tab">大テスト別<br/>
                            受験者数</a></li>
                        ...
                        <div class="box">
                            <div class="box-header">
                                <form id="form-search" class="form-horizontal"
                                      action="{{ route('access-analysis.big-tests') }}" method="get"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8 text-center">
                                            <a href="{{route('access-analysis.big-tests.download')}}" class="btn btn-default ">CSVダウンロード</a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="chapterName" class="col-sm-4 control-label">グレード名</label>
                                                <div class="col-sm-8 ">
                                    ...
                                    <tbody>
                                        @if(count($data) > 0)
                                            @foreach($data as $item)
                                                ...
                                                <td>{{$item->lang}}</td>
                                                <td>{{$item->total}}({{$item->pass_result}}/{{$item->fail_result}})</td>
                                                </tr>
                                            @endforeach
                                        @endif
                                    </tbody>
